            ...
            <div class="row g-3 mt-2">
                ...
                <div class="col-md-6" id="parent-row">
                    ...
                    <select class="form-select @error('parent_id') is-invalid @enderror" id="parent_id" name="parent_id">
                        ...
                        <option value="{{ $p->id }}" {{ old('parent_id', $warehouse->parent_id) == $p->id ? 'selected' : '' }}>{{ $p->kode_gudang }} - {{ $p->nama_gudang }}</option>
                        @endforeach
                    </select>
...
<div class="card border-0 shadow-sm mt-4">
    <div class="card-header bg-white py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
        ...
        <a href="{{ route('warehouses.create', ['parent_id' => $warehouse->id]) }}" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Tambah Cabang</a>
        @endcan
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                @if($child->children->isNotEmpty() || $child->children->isEmpty())
                                <a href="{{ route('warehouses.create', ['parent_id' => $child->id]) }}" class="btn btn-sm btn-success text-white" title="Add Sub"><i class="bi bi-plus"></i></a>
                                @endif
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <a href="{{ route('warehouses.create', ['parent_id' => $sub->id]) }}" class="btn btn-sm btn-success text-white" title="Add Sub"><i class="bi bi-plus"></i></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
