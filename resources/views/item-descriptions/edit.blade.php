...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="fw-bold mb-0">Edit: {{ $itemDescription->masti_code }} - {{ $itemDescription->masti_name }}</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('item-descriptions.update', $itemDescription) }}">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('masti_code') is-invalid @enderror" id="masti_code" name="masti_code" value="{{ old('masti_code', $itemDescription->masti_code) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('masti_name') is-invalid @enderror" id="masti_name" name="masti_name" value="{{ old('masti_name', $itemDescription->masti_name) }}">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" class="form-control @error('masti_capacity') is-invalid @enderror" id="masti_capacity" name="masti_capacity" value="{{ old('masti_capacity', $itemDescription->masti_capacity) }}" required>
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select @error('uom_id_1') is-invalid @enderror" id="uom_id_1" name="uom_id_1" required>
                        ...
                        @foreach($uoms as $u)
                            <option value="{{ $u->uom_id }}" {{ (old('uom_id_1', $itemDescription->uom_id_1)) == $u->uom_id ? 'selected' : '' }}>{{ $u->uom_code }} - {{ $u->uom_name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('cati_id') is-invalid @enderror" id="cati_id" name="cati_id">
                        ...
                        @foreach($categories as $cat)
                            <option value="{{ $cat->cati_id }}" {{ (old('cati_id', $itemDescription->cati_id)) == $cat->cati_id ? 'selected' : '' }}>
