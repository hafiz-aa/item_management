...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="fw-bold mb-0">TAMBAH BRANCH BARU</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('branches.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check form-switch mt-2">
                        <input class="form-check-input" type="checkbox" role="switch" id="branch_is_headquarter" name="branch_is_headquarter" value="0" {{ old('branch_is_headquarter', '1') == '0' ? 'checked' : '' }}>
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('branch_address') is-invalid @enderror" id="branch_address" name="branch_address" rows="3">{{ old('branch_address') }}</textarea>
