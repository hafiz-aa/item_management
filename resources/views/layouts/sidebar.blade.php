<nav class="sidebar sidebar-dark bg-dark d-flex flex-column flex-shrink-0 p-0 text-white" style="width: 260px; min-height: 100vh;">
    <div class="sidebar-header d-flex align-items-center p-3 border-bottom border-secondary">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <small class="text-secondary">Warehouse Management</small>
            </div>
        </div>
    </div>
    ...
    <div class="sidebar-menu flex-grow-1 overflow-auto py-2">
        <ul class="nav nav-pills flex-column">
            <li class="nav-item px-2 mb-1">
                <a href="{{ route('dashboard') }}" class="nav-link text-white {{ request()->routeIs('dashboard') ? 'active bg-primary' : 'text-white' }}">
            ...
            <li class="nav-item px-2 mb-1">
                <a href="{{ route('warehouses.index') }}" class="nav-link text-white {{ request()->routeIs('warehouses.*') ? 'active bg-primary' : '' }}">
            ...
            @can('item.import')
            <li class="nav-item px-2 mb-1">
                <a href="{{ route('import.create') }}" class="nav-link text-white {{ request()->routeIs('import.*') ? 'active bg-primary' : '' }}">
            ...
            <li class="nav-item px-2 mb-1">
                <a href="{{ route('activity-logs.index') }}" class="nav-link text-white {{ request()->routeIs('activity-logs.*') ? 'active bg-primary' : '' }}">
