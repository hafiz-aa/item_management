            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select @error('tth_status') is-invalid @enderror" id="tth_status" name="tth_status" required>
                        <option value="0" {{ old('tth_status', $transfer->tth_status) === '0' ? 'selected' : '' }}>Belum Diterima</option>
                        <option value="1" {{ old('tth_status', $transfer->tth_status) === '1' ? 'selected' : '' }}>Diterima Sebagian</option>
                        <option value="2" {{ old('tth_status', $transfer->tth_status) === '2' ? 'selected' : '' }}>Diterima Semua</option>
                    </select>
