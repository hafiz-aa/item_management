...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="fw-bold mb-0">Edit: {{ $uom->uom_code }} - {{ $uom->uom_name }}</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('uoms.update', $uom) }}">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('uom_code') is-invalid @enderror" id="uom_code" name="uom_code" value="{{ old('uom_code', $uom->uom_code) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('uom_name') is-invalid @enderror" id="uom_name" name="uom_name" value="{{ old('uom_name', $uom->uom_name) }}" required>
