...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="fw-bold mb-0">TAMBAH EMPLOYEE BARU</h5>
    </div>
    <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('emp_sex') is-invalid @enderror" id="emp_sex" name="emp_sex">
                        ...
                        <option value="0" {{ old('emp_sex') === '0' ? 'selected' : '' }}>Perempuan</option>
                        <option value="1" {{ old('emp_sex') === '1' ? 'selected' : '' }}>Laki-laki</option>
                    </select>
                    @error('emp_sex') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                    <label for="emp_phone" class="form-label">Telepon</label>
                    <input type="text" class="form-control @error('emp_phone') is-invalid @enderror" id="emp_phone" name="emp_phone" value="{{ old('emp_phone') }}">
                    @error('emp_phone') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                    <label for="emp_email" class="form-label">Email</label>
                    <input type="email" class="form-control @error('emp_email') is-invalid @enderror" id="emp_email" name="emp_email" value="{{ old('emp_email') }}">
