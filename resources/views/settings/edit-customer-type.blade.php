...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="fw-bold mb-0">Edit: {{ $customerType->custtp_code }} - {{ $customerType->custtp_name }}</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('customer-types.update', $customerType) }}">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('custtp_code') is-invalid @enderror" id="custtp_code" name="custtp_code" value="{{ old('custtp_code', $customerType->custtp_code) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('custtp_name') is-invalid @enderror" id="custtp_name" name="custtp_name" value="{{ old('custtp_name', $customerType->custtp_name) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('custtp_is_active') is-invalid @enderror" id="custtp_is_active" name="custtp_is_active" required>
                        <option value="0" {{ old('custtp_is_active', $customerType->custtp_is_active) === '0' ? 'selected' : '' }}>Active</option>
                        <option value="1" {{ old('custtp_is_active', $customerType->custtp_is_active) === '1' ? 'selected' : '' }}>Inactive</option>
                    </select>
