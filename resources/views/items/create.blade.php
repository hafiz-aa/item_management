...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="fw-bold mb-0">Create New Item / Tabung</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('items.store') }}">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('kode_tabung') is-invalid @enderror" id="kode_tabung" name="kode_tabung" value="{{ old('kode_tabung') }}" required>
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-6">
                    ...
                    <textarea class="form-control @error('deskripsi_isi_tabung') is-invalid @enderror" id="deskripsi_isi_tabung" name="deskripsi_isi_tabung" rows="3">{{ old('deskripsi_isi_tabung') }}</textarea>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error('pemilik_tabung') is-invalid @enderror" id="pemilik_tabung" name="pemilik_tabung" value="{{ old('pemilik_tabung') }}">
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control @error('tahun_pembuatan') is-invalid @enderror" id="tahun_pembuatan" name="tahun_pembuatan" min="1900" max="{{ date('Y') }}" value="{{ old('tahun_pembuatan', date('Y')) }}">
                    @error('tahun_pembuatan') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-3">
                    <label for="berat" class="form-label">Berat</label>
                    <input type="number" step="0.01" class="form-control @error('berat') is-invalid @enderror" id="berat" name="berat" value="{{ old('berat', '0') }}">
                    @error('berat') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-3">
                    <label for="kapasitas" class="form-label">Kapasitas</label>
                    <input type="number" step="0.01" class="form-control @error('kapasitas') is-invalid @enderror" id="kapasitas" name="kapasitas" value="{{ old('kapasitas', '0') }}">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select @error('uom') is-invalid @enderror" id="uom" name="uom">
                        ...
                        <option value="M3" {{ old('uom') == 'M3' ? 'selected' : '' }}>M3</option>
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select @error('lokasi_gudang_id') is-invalid @enderror" id="lokasi_gudang_id" name="lokasi_gudang_id">
                        ...
                        @foreach($warehouses as $w)
                            <option value="{{ $w->id }}" {{ old('lokasi_gudang_id') == $w->id ? 'selected' : '' }}>{{ $w->nama_gudang }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-6">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="rusak" name="rusak" value="1" {{ old('rusak') ? 'checked' : '' }}>
                        <label class="form-check-label" for="rusak">Rusak</label>
                    </div>
                    <div class="form-check form-switch mt-2">
                        <input class="form-check-input" type="checkbox" role="switch" id="dijual" name="dijual" value="1" {{ old('dijual') ? 'checked' : '' }}>
