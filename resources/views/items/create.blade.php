        ...
        <form method="POST" action="{{ route('items.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" step="0.01" class="form-control @error('masti_capacity') is-invalid @enderror" id="masti_capacity" name="masti_capacity" value="{{ old('masti_capacity', '0') }}">
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select @error('cati_id') is-invalid @enderror" id="cati_id" name="cati_id">
                        ...
                        @foreach($categories as $cat)
                            <option value="{{ $cat->cati_id }}" {{ old('cati_id') == $cat->cati_id ? 'selected' : '' }}>{{ $cat->cati_code }} - {{ $cat->cati_name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" class="form-control @error('itemd_qty') is-invalid @enderror" id="itemd_qty" name="itemd_qty" min="1" value="{{ old('itemd_qty', '1') }}">
                ...
                <div class="col-md-2">
                    ...
                    <input type="date" class="form-control @error('itemd_acquired_date') is-invalid @enderror" id="itemd_acquired_date" name="itemd_acquired_date" value="{{ old('itemd_acquired_date') }}">
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select @error('whsl_id') is-invalid @enderror" id="whsl_id" name="whsl_id">
                        ...
                        @foreach($warehouses as $w)
                            <option value="{{ $w->whsl_id }}" {{ old('whsl_id') == $w->whsl_id ? 'selected' : '' }}>{{ $w->whsl_name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select @error('itemd_status') is-invalid @enderror" id="itemd_status" name="itemd_status">
                        <option value="0" {{ old('itemd_status', '0') == '0' ? 'selected' : '' }}>Aktif</option>
                        <option value="1" {{ old('itemd_status') == '1' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-6">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="itemd_is_broken" name="itemd_is_broken" value="1" {{ old('itemd_is_broken') ? 'checked' : '' }}>
                        <label class="form-check-label" for="itemd_is_broken">Broken</label>
                    </div>
                    <div class="form-check form-switch mt-2">
                        <input class="form-check-input" type="checkbox" role="switch" id="itemd_is_dispossed" name="itemd_is_dispossed" value="1" {{ old('itemd_is_dispossed') ? 'checked' : '' }}>
                        <label class="form-check-label" for="itemd_is_dispossed">Disposed</label>
                    </div>
                    <div class="form-check form-switch mt-2">
                        <input class="form-check-input" type="checkbox" role="switch" id="itemd_is_wo" name="itemd_is_wo" value="1" {{ old('itemd_is_wo') ? 'checked' : '' }}>
