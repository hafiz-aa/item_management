        ...
        $(document).ready(function() {
            ...
            $('.btn-delete').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    text: 'Apakah Anda yakin ingin menghapus receive ini?',
                    icon: 'warning',
...
@section('content')
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
            ...
            <a href="{{ route('transactions.receive.create') }}" class="btn btn-primary btn-sm">
                <i class="bi bi-plus-lg"></i> Tambah Receive Baru
            </a>
        </div>
        <div class="card-body">
            <form method="GET" action="{{ route('transactions.receive.index') }}" class="row g-2 mb-3">
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    <a href="{{ route('transactions.receive.index') }}" class="btn btn-sm btn-secondary w-100"><i
            ...
            <div class="table-responsive">
                <table id="receiveTable" class="table table-hover table-striped align-middle" style="width:100%">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('transactions.receive.show', $receive) }}"
                                            class="btn btn-sm btn-info text-white" title="View">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('transactions.receive.edit', $receive) }}"
                                            class="btn btn-sm btn-warning text-white" title="Edit">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('transactions.receive.destroy', $receive) }}" method="POST">
                                            @csrf @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="11" class="text-center py-4 text-muted">Tidak ada data receive.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
