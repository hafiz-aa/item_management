...
@section('content')
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('transactions.change-description') }}" class="row g-2 mb-3">
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    <a href="{{ route('transactions.change-description') }}" class="btn btn-sm btn-secondary w-100"><i class="bi bi-x-lg"></i></a>
                </div>
            </form>
                    ...
                    <tbody>
                        @forelse($changes as $change)
                            <tr>
                                ...
                                <td class="text-truncate" style="max-width: 250px;" title="{{ $change->cidh_notes ?? '' }}">
                                    {{ $change->cidh_notes ?? '-' }}
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-4 text-muted">Tidak ada data change item description.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
