...
@section('title', 'Tambah Issue Item')
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="fw-bold mb-0">TAMBAH ISSUE BARU</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('transactions.issue.store') }}">
            @csrf
            <div class="row g-3 mb-4">
                <div class="col-md-3">
                    <label for="issuingh_date" class="form-label">Tanggal <span class="text-danger">*</span></label>
                    <input type="date" class="form-control @error('issuingh_date') is-invalid @enderror" id="issuingh_date" name="issuingh_date" value="{{ old('issuingh_date', date('Y-m-d')) }}" required>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select @error('issuingh_type') is-invalid @enderror" id="issuingh_type" name="issuingh_type" required>
                        <option value="0" {{ old('issuingh_type') === '0' ? 'selected' : '' }}>Customer</option>
                        <option value="1" {{ old('issuingh_type') === '1' ? 'selected' : '' }}>Vendor</option>
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error('issuingh_receiver_name') is-invalid @enderror" id="issuingh_receiver_name" name="issuingh_receiver_name" value="{{ old('issuingh_receiver_name') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error('issuingh_ba_no') is-invalid @enderror" id="issuingh_ba_no" name="issuingh_ba_no" value="{{ old('issuingh_ba_no') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error('issuingh_po_no') is-invalid @enderror" id="issuingh_po_no" name="issuingh_po_no" value="{{ old('issuingh_po_no') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error('issuingh_do_no') is-invalid @enderror" id="issuingh_do_no" name="issuingh_do_no" value="{{ old('issuingh_do_no') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error('issuingh_sent_by') is-invalid @enderror" id="issuingh_sent_by" name="issuingh_sent_by" value="{{ old('issuingh_sent_by') }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error('issuingh_vehicle_no') is-invalid @enderror" id="issuingh_vehicle_no" name="issuingh_vehicle_no" value="{{ old('issuingh_vehicle_no') }}">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control @error('issuingh_notes') is-invalid @enderror" id="issuingh_notes" name="issuingh_notes" value="{{ old('issuingh_notes') }}">
