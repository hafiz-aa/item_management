...
@section('content')
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('transactions.broken') }}" class="row g-2 mb-3">
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    <a href="{{ route('transactions.broken') }}" class="btn btn-sm btn-secondary w-100"><i class="bi bi-x-lg"></i></a>
                </div>
            </form>
            ...
            <div class="table-responsive">
                <table id="brokenTable" class="table table-hover table-striped align-middle" style="width:100%">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-4 text-muted">Tidak ada data broken.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
