...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h5 class="fw-bold mb-0">Edit: {{ $category->category_code }} - {{ $category->category_name }}</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('item-categories.update', $category) }}">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('category_code') is-invalid @enderror" id="category_code" name="category_code" value="{{ old('category_code', $category->category_code) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="1">{{ old('description', $category->description) }}</textarea>
